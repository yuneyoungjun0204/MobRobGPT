...
anchoring one candidate to the geometric heuristic so that only joint actions that beat
the heuristic receive positive advantage. In the strategy layer a large language model (LLM) commander
